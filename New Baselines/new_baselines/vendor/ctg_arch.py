# Adapted from montrealrobotics/ctrl-sim (MIT); see LICENSE and PROVENANCE.json.
import torch
...
from .train_utils import weight_init
from .sinusoidal import SinusoidalPosEmb
...
from .social_attention import RelativeSocialAttentionLayer
...
class DiT(nn.Module):
    ...
    def temporal_attn_fn(self, agents_emb, agent_masks, layer):
        ...
        # Local fix: the all-padding attention sentinel must not mutate the
        # shared existence mask used later by social attention.
        agent_masks = agent_masks.permute(0, 2, 1).reshape(-1, T_obs).clone()
